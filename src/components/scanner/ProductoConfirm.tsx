        ...
        <div className="mb-4">
          ...
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0 pt-1">
              <ProductIdentity producto={producto} showImage={false} compact />
              {fotoGuardada && (
              ...
              {errorFoto && <p className="text-red-500 text-xs mt-2">{errorFoto}</p>}
              {subiendo && <p className="text-muted-foreground text-xs mt-2">Subiendo foto...</p>}
            </div>
          </div>
