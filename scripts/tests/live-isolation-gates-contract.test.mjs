...
assert.match(gates, /p_vencimiento_id: IDS\.expiryA1/)
assert.match(gates, /Gate 1:/)
assert.match(gates, /Gate 2:/)
assert.match(gates, /Gate 3:/)
assert.match(gates, /Gate 4:/)
assert.match(gates, /rpc\/listar_bandeja_rag_zonal/)
assert.match(gates, /rpc\/ejecutar_solicitud_cambio_rag/)
...
assert.match(workflow, /Live isolation Gates 1-4/)
...
console.log('live isolation Gates 1-4 contract: OK')
