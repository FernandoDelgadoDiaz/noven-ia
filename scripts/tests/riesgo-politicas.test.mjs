...
eq('Lácteos legacy = 2 días', diasDonacionLegacyPorSector('LACTEOS'), 2)
eq('Panadería legacy = 2 días', diasDonacionLegacyPorSector('PANADERÍA'), 2)
eq('Almacén legacy = 10 días', diasDonacionLegacyPorSector('ALMACEN'), 10)
eq('Sector no configurado conserva fallback 10', diasDonacionLegacyPorSector('FIAMBRES'), 10)
