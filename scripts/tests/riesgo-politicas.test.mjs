...
seccion('Política explícita de donación')
// La asignación sector -> 2/10/NULL vive en PostgreSQL. El motor recibe el valor
// ya resuelto y nunca lo deriva a partir del nombre del sector.
...
// - política 10: 30 días comerciales => RADAR
// - política 2: 38 días comerciales => SEGURO
eq('40 días, política 10: riesgo antes de donación => radar', calcularNivelRiesgo(40, 100, 3, 10), 'radar')
eq('40 días, política 2: alcanza antes de donación => seguro', calcularNivelRiesgo(40, 100, 3, 2), 'seguro')
