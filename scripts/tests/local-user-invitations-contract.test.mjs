...
assert.match(backend, /eliminarAuthUser\(event, supabaseUrl, serviceRoleKey, usuarioId\)/)
assert.match(backend, /operation: 'compensate_delete_auth_user'/)
...
console.log('✓ Alta local usa invitaciones seguras y compensación observable sin contraseñas iniciales')
