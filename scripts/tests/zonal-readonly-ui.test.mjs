...
assert.match(layout, /\(esSoloAdministrativaPrecios \? \[\] : BASE_NAV_ITEMS\)\.filter\(\(item\) => \(item\.to !== '\/scanner' \|\| puedeOperar\)/,
...
console.log('✓ gerente zonal: UI operativa de lectura, sin Scanner ni acciones locales')
