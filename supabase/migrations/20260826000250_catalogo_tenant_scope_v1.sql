...
--
-- Compatibilidad:
--   Producción y el historial reproducible tienen drift en algunas constraints
--   legacy. Los DROP usan IF EXISTS y luego esta migración impone las nuevas
--   constraints por tenant como fuente de verdad.
-- =============================================================================
...
ALTER TABLE public.sectores DROP CONSTRAINT IF EXISTS sectores_codigo_key;
ALTER TABLE public.sectores
...
ALTER TABLE public.familias DROP CONSTRAINT IF EXISTS familias_sector_id_fkey;
ALTER TABLE public.familias
...
ALTER TABLE public.familias DROP CONSTRAINT IF EXISTS familias_codigo_key;
ALTER TABLE public.familias
...
ALTER TABLE public.productos DROP CONSTRAINT IF EXISTS productos_familia_id_fkey;

ALTER TABLE public.productos DROP CONSTRAINT IF EXISTS productos_cod_art_key;
ALTER TABLE public.productos
